...
class FindAccountFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("FindAccount", "FindAccountFragment 실행됨")
        ...
        binding.btnBack.setOnClickListener {
            ...
            requireActivity().findViewById<View>(R.id.login_intro_fragment_container).visibility = View.GONE
            requireActivity().findViewById<View>(R.id.login_intro_layout).visibility = View.VISIBLE
        }
        ...
        binding.btnConfirmCodePw.setOnClickListener {
            showCustomDialog(
                ...
                val containerId = R.id.login_intro_fragment_container
